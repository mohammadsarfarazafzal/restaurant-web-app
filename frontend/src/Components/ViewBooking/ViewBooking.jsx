...
//         Your Booking Details <br/><span className="text-sm text-blue-gray-800 font-semibold ">Booked table will be cancelled by 24 hours of booking !!</span>
//       </h1>
...
function ViewBooking() {
  ...
  const cancelBooking = async (id) => {
    try {
      const res = await axios.post(
        "http://localhost:8000/api/v1/tableBooking/cancel-booking",
        { bookingId: id },
        { withCredentials: true }
      );
      if (res.data.success) {
